...
<div style="width:100%; height:100%;;background-color:#5AB81A; color:white; text-align:center;">
    <ul class="nav nav-tabs" role="tablist" id="myTab" style="height:100%;">
    	<c:if test="${menu eq 'id' }">
    		<li role="presentation" class="active" style="height:100%;">
			 	 <a href="#home" aria-controls="home" role="tab" data-toggle="tab">아이디 찾기</a>
			  </li>
			  
			  <li role="presentation" style="height:100%;">
			  	<a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">비밀번호찾기</a>
			  </li>
    	</c:if>
