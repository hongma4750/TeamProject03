...
<!-- <ul class="nav nav-tabs" role="tablist" id="myTab">
  <li role="presentation" class="active" data-target="#layerpop" data-toggle="modal"><a href="newlist.do" aria-controls="home" role="tab" data-toggle="tab">이웃소식보기</a></li>
  <li role="presentation"><a href="newlist.do" aria-controls="profile" role="tab" data-toggle="tab">주제별 글보기</a></li>
